...
public class TVTrain {
    ...
    public Short getFtrainordernum() {
        return ftrainordernum;
    }

    public void setFtrainordernum(Short ftrainordernum) {
    ...
    public void setFtrainnonum(String ftrainnonum) {
        this.ftrainnonum = ftrainnonum == null ? null : ftrainnonum.trim();
    }
    ...
    public Integer getFconsignernum() {
        return fconsignernum;
    }

    public void setFconsignernum(Integer fconsignernum) {
    ...
    public void setFdisbuttcodevcr(String fdisbuttcodevcr) {
        this.fdisbuttcodevcr = fdisbuttcodevcr == null ? null : fdisbuttcodevcr.trim();
    }
    ...
    public void setFtrainnonum2(String ftrainnonum2) {
        this.ftrainnonum2 = ftrainnonum2 == null ? null : ftrainnonum2.trim();
    }
