...
public class ShipServiceImpl extends ServiceImpl<TVShipmainMapper, TVShipmain> implements ShipService {
    ...
    public List<Map<String, Object>> list_ship6(String str_company, String dt_year) {
        return this.baseMapper.list_ship6(str_company,dt_year);
    }
    ...
    public List<Map<String, Object>> list_ship8(String str_company, String str_shipno,String dt_start,String dt_end) {
        return this.baseMapper.list_ship8(str_company,str_shipno,dt_start,dt_end);
    }
    ...
    public List<Map<String, Object>> list_ship5(String str_company, String dt_start, String dt_end) {
        return this.baseMapper.list_ship5(str_company,dt_start,dt_end);
    }
    public List<Map<String, Object>> list_ship5D(String str_company, String dt_start, String dt_end,String str_state) {
        return this.baseMapper.list_ship5D(str_company,dt_start,dt_end,str_state);
    }
}
